...
public class Jmeter_QRCode {
	private static final String VERSION = "1.0.0.0";
	private static final String COMMENT = "2019-04-25 09:01  胡义东 初始化";
	 ...
	 *            生成二维码文件地址及文件名字符串
	 */
	public static void qrCodeEncode(String encodeddata, String filePath)
			throws IOException {
	...
	public static String qrCodeDecode(String filePath) {
		...
		try {
			decodedData = new String(decoder.decode(new J2SEImage(image)),
					"GBK");
